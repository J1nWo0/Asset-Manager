...
const categoryOptions = computed(() => {
    const uniqueCats = [
        ...new Set(assets.value.map((a) => a.category).filter(Boolean)),
    ];
    return [
...
<template>
    <div class="px-16 py-4">
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                />
                                <div
                                    class="absolute bg-black bg-opacity-60 text-white text-xs px-2 py-1 rounded top-2 left-2"
                                >
                                    {{ item.category }}
                                </div>
                            </div>
        ...
        <!-- Asset Modal -->
        <AssetModal v-model="showModal" :asset="selectedAsset" @updated="fetchAssets" />
    </div>
</template>
